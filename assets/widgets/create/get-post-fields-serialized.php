...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	$no_of_columns = spnxHelper::getFilterVar( 'no_of_columns', INPUT_POST, FILTER_VALIDATE_INT);
	$unserialized_storage_meta['no_of_columns'] = $no_of_columns;
	/* no_of_columns Inserting Starts Here */

	/* widget_layout_type Inserting Starts Here */
	$widget_layout_type = spnxHelper::getFilterVar( 'widget_layout_type', INPUT_POST, FILTER_SANITIZE_STRING);
	$unserialized_storage_meta['widget_layout_type'] = $widget_layout_type;
	/* widget_layout_type Inserting Starts Here */
	/* unit_layout_type Inserting Starts Here */
	$unit_layout_type = spnxHelper::getFilterVar( 'unit_layout_type', INPUT_POST, FILTER_SANITIZE_STRING);
	$unserialized_storage_meta['unit_layout_type'] = $unit_layout_type;
	/* unit_layout_type Inserting Starts Here */
	/* unit_spacing Inserting Starts Here */
	$unit_spacing = spnxHelper::getFilterVar( 'unit_spacing', INPUT_POST, FILTER_VALIDATE_INT);
	$unserialized_storage_meta['unit_spacing'] = $unit_spacing;
	/* unit_spacing Inserting Starts Here */

	/* img_crop_width Inserting Starts Here */
	$img_crop_width = spnxHelper::getFilterVar( 'img_crop_width', INPUT_POST, FILTER_VALIDATE_INT);
	$unserialized_storage_meta['img_crop_width'] = $img_crop_width;
	/* img_crop_width Inserting Starts Here */

	/* img_crop_height Inserting Starts Here */
	$img_crop_height = spnxHelper::getFilterVar( 'img_crop_height', INPUT_POST, FILTER_VALIDATE_INT);
	$unserialized_storage_meta['img_crop_height'] = $img_crop_height;

	$img_height = spnxHelper::getFilterVar( 'img_height', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_bg_color = spnxHelper::getFilterVar( 'unit_bg_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_fg_color = spnxHelper::getFilterVar( 'unit_fg_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_border_width = spnxHelper::getFilterVar( 'unit_border_width', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_border_style = spnxHelper::getFilterVar( 'unit_border_style', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_border_color = spnxHelper::getFilterVar( 'unit_border_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_border_radius = spnxHelper::getFilterVar( 'unit_border_radius', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_title_font_size = spnxHelper::getFilterVar( 'unit_title_font_size', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_title_line_height = spnxHelper::getFilterVar( 'unit_title_line_height', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_title_font_style = spnxHelper::getFilterVar( 'unit_title_font_style', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_title_font_color = spnxHelper::getFilterVar( 'unit_title_font_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_title_font_family = spnxHelper::getFilterVar( 'unit_title_font_family', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_title_font_case = spnxHelper::getFilterVar( 'unit_title_font_case', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_add_line_width = spnxHelper::getFilterVar( 'unit_add_line_width', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_add_line_style = spnxHelper::getFilterVar( 'unit_add_line_style', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_add_line_color = spnxHelper::getFilterVar( 'unit_add_line_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_excerpt_font_size = spnxHelper::getFilterVar( 'unit_excerpt_font_size', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_excerpt_line_height = spnxHelper::getFilterVar( 'unit_excerpt_line_height', INPUT_POST, FILTER_VALIDATE_INT);
	...
	$unit_excerpt_font_style = spnxHelper::getFilterVar( 'unit_excerpt_font_style', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_excerpt_font_color = spnxHelper::getFilterVar( 'unit_excerpt_font_color', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_excerpt_font_family = spnxHelper::getFilterVar( 'unit_excerpt_font_family', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_excerpt_font_case = spnxHelper::getFilterVar( 'unit_excerpt_font_case', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$unit_excerpt_word_limit = spnxHelper::getFilterVar( 'unit_excerpt_word_limit', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	/* unit_excerpt_word_limit Inserting Starts Here */
	$unit_show_views = spnxHelper::getFilterVar( 'unit_show_views', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$widget_recent_percentage = spnxHelper::getFilterVar( 'widget_recent_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$widget_popular_percentage = spnxHelper::getFilterVar( 'widget_popular_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$widget_related_percentage = spnxHelper::getFilterVar( 'widget_related_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$allow_global_checkbox = spnxHelper::getFilterVar( 'allow_global_checkbox', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$global_post_percentage = spnxHelper::getFilterVar( 'global_post_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$mysite_post_percentage = spnxHelper::getFilterVar( 'local_post_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$sponsored_post_percentage = spnxHelper::getFilterVar( 'ad_post_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$page_takeover_checkbox = spnxHelper::getFilterVar( 'page_takeover_checkbox', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$allow_global_url_checkbox = spnxHelper::getFilterVar( 'allow_global_url_checkbox', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$allow_global_url_textarea = spnxHelper::getFilterVar( 'allow_global_url_textarea', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$global_url_post_percentage = spnxHelper::getFilterVar( 'global_url_post_percentage', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$block_global_url_checkbox = spnxHelper::getFilterVar( 'block_global_url_checkbox', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$global_blocked_url_textarea = spnxHelper::getFilterVar( 'global_blocked_url_textarea', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$global_blocked_keywords_textarea = spnxHelper::getFilterVar( 'global_blocked_keywords_textarea', INPUT_POST, FILTER_SANITIZE_STRING);
	...
	$global_blocked_categories_textarea = spnxHelper::getFilterVar( 'global_blocked_categories_textarea', INPUT_POST, FILTER_SANITIZE_STRING);
