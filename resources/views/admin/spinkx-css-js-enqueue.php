...
function spinkx_header_menu() {
	...
	if('spinkx_content_play_list' === $page ) {
		...
		if( $cp_noitce_info ) {
			...
			echo '<a href="javascript:;void(0)" class="spnx-faq" onclick="showNoticeCP();" style="margin-top: 10px; margin-left:604px;"><i>Boost Post FAQ\'s</i></a>';
			$info_flag = true;
		}
		...
		if(  $campaigns_noitce_info ) {
			...
			echo '<a href="javascript:;void(0)" class="spnx-faq" onclick="showNoticeCampaign();" style="margin-top: 10px; margin-left:759px;"><i>Campaign FAQ\'s</i></a>';
			$info_flag = true;
		}
	 }
	 if( $noitce_flag ) {
