...
wp_enqueue_style( 'css-evol-colorpicker', $vendor . 'evol-colorpicker/css/evol.colorpicker.min.css' );
wp_enqueue_style( 'css-add-widget', $dist  . 'css/add-widget.'.$css );
wp_enqueue_style( 'css-add-widget-preview', $dist . 'css/add-widget-preview.'.$css );
...
require  "{$path}widgets/default-field-values.php";
/****************************** Default Field Values ***************************/
?>
...
/****************************** Include Page Scripts *********************************/
	require "{$path}widgets/add-widget-dynamic-scripts.php";
	/****************************** Include Page Scripts *********************************/
